...
interface IZeroIonProps {
    isHover: boolean;
    isDisabled: boolean;
    size?: string;
}

export const ZeroIcon: React.FunctionComponent<IZeroIonProps> = ({
    isDisabled,
    size = '24',
}) => {
    return (
