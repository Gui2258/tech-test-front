...
describe('SunButton', () => {
    ...
    it('renders sun button with "Highlight" text in desktop view', () => {
        renderComponent();
    ...
    it('applies correct text styles for different states', () => {
        ...
        const textSpan = screen.getByText('Highlight');
        ...
        const enabledTextSpan = screen.getByText('Highlight');
